      ...
      column(
        ...
        box(
          ...
          radioButtons(ns("method"), "Metode Kategorisasi:", 
                      choices = c("Interval Sama" = "interval", 
  ...
  tabItem(
    ...
    fluidRow(
      column(
        width = 3,
        box(
          title = tags$span(icon("settings"), "Pengaturan Uji"),
          status = "primary",
          solidHeader = TRUE,
          width = NULL,
          h5("Uji Normalitas:"),
      ...
      column(
        ...
        box(
          ...
          radioButtons(ns("test_type"), "Jenis Uji:", 
                      choices = c("Satu Sampel" = "one_sample", 
      ...
      column(
        ...
        box(
          ...
          conditionalPanel(
            ...
            numericInput(ns("p_test"), "Proporsi Uji (p₀):", value = 0.5, 
