...
**Jenis Analisis:** `r params$jenis_anova`

**Variabel Terikat:** `r params$variabel_dependen`

**Faktor:** `r params$faktor`
...
if (!is.null(params$input_params)) {
    if (params$input_params$anova_type == "one_way") {
        cat("**Model:** ", params$variabel_dependen, " ~ ", params$faktor, "\n\n")
        cat("**Tipe ANOVA:** Satu Arah (One-Way ANOVA)\n\n")
        cat(
            "**Tujuan:** Menguji apakah terdapat perbedaan rata-rata ", params$variabel_dependen,
            " antar kategori ", params$faktor, "\n\n"
        )
    } else {
        cat("**Model:** ", params$variabel_dependen, " ~ ", params$faktor, "\n\n")
        cat("**Tipe ANOVA:** Dua Arah (Two-Way ANOVA)\n\n")
        cat("**Tujuan:** Menguji pengaruh dua faktor dan interaksinya terhadap ", params$variabel_dependen, "\n\n")
    }
}
```
...
if (!is.null(params$input_params)) {
    if (params$input_params$anova_type == "one_way") {
        ...
        cat("**H₀ (Hipotesis Nol):**\n")
        cat("- Tidak ada pengaruh faktor utama A\n")
        cat("- Tidak ada pengaruh faktor utama B\n")
        cat("- Tidak ada pengaruh interaksi A×B\n\n")
        cat("**H₁ (Hipotesis Alternatif):**\n")
        cat("- Ada pengaruh minimal satu faktor utama atau interaksi\n\n")
    }
}
```
