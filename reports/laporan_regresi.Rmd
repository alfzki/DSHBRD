...
if (!is.null(params$variabel_independen)) {
    ...
    ft <- knitr::kable(var_df,
        caption = "Variabel yang Digunakan dalam Model"
    ) %>%
        kable_styling(
...
if (!is.null(params$hasil_regresi)) {
    ...
    ft <- knitr::kable(model_stats,
        col.names = c("Statistik Model", "Nilai"),
        caption = "Ringkasan Statistik Model Regresi"
    ) %>%
        kable_styling(
            bootstrap_options = c("striped", "hover"),
            full_width = FALSE,
...
if (!is.null(params$hasil_regresi)) {
    ...
    ft <- knitr::kable(coeff_df,
        col.names = c("Variabel", "Koefisien (β)", "Std. Error", "t-statistic", "p-value", "Sig."),
        caption = "Koefisien Regresi dan Signifikansi"
    ) %>%
        kable_styling(
            bootstrap_options = c("striped", "hover"),
            full_width = FALSE,
...
if (!is.null(params$uji_asumsi)) {
    ...
    ft <- knitr::kable(assumption_df,
        caption = "Hasil Uji Asumsi Model Regresi"
    ) %>%
        kable_styling(
            bootstrap_options = c("striped", "hover"),
            full_width = FALSE,
