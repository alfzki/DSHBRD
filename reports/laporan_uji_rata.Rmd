...
if (!is.null(params$input_params)) {
    ...
    ft <- knitr::kable(param_df,
        col.names = c("Parameter Uji", "Nilai"),
        caption = "Parameter Uji yang Digunakan"
    ) %>%
        kable_styling(
...
if (!is.null(params$hasil_uji)) {
    ...
    ft <- knitr::kable(hasil_df,
        col.names = c("Statistik Uji", "Nilai"),
        caption = "Hasil Uji Statistik"
    ) %>%
        kable_styling(
            bootstrap_options = c("striped", "hover"),
            full_width = FALSE,
